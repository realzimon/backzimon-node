...
describe('PostTimer', function () {
  describe('from idle', function () {
    ...
    it('should not to preparation at 11:05', function () {
      justCheckFromToExpected(11, 5, STATES.IDLE, STATES.IDLE, STATES.ACTION);
    });
    ...
    it('should not switch to preparation at 15:05', function () {
      justCheckFromToExpected(15, 5, STATES.IDLE, STATES.IDLE, STATES.ACTION);
    });
